...
const ChatClassificationFiltered = () => {
  ...
  return (
    <div className="bot-messages">
      ...
      <div className="content">
        <div class="header">
          <h2>Chat Analysis (Abusive Removed)</h2>
        </div>
        ...
        <div>
          <table>
            ...
            <tbody>
            {chatHisoty
                ?.filter((item) => item["category"] !== "Abusive")
                .map((item, key) => (
                  <tr key={key}>
                    <td>
        ...
        <div>
          ...
          <button class="buttonFlat" onClick={handleNextPage}>
            Next
          </button>
        </div>
      </div>
...
export default ChatClassificationFiltered;